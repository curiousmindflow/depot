...
Depot welcomes contribution from everyone in the form of suggestions, bug reports, pull requests, and feedback. This document gives some guidance if you are thinking of helping me.
...
If you've found a bug or an issue with Depot, i would appreciate if you could:
...
1. **Fork the Repository**: Start by [forking the repository](https://github.com/curiousmindflow/depot/fork) and cloning it locally.

```
git clone https://github.com/curiousmindflow/depot.git
cd depot
```
